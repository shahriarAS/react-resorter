...
function Footer() {
    return (
            ...
            <div class="border-t border-gray-800">
                <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
                    <div class="flex md:flex-no-wrap flex-wrap justify-center md:justify-start">
                        <input class="sm:w-64 w-40 bg-gray-800 rounded sm:mr-4 mr-2 border border-gray-700 text-white focus:outline-none focus:border-indigo-500 text-base py-2 px-4" placeholder="Placeholder" type="text" />
                        ...
                        <p class="text-gray-600 text-sm md:ml-6 md:mt-0 mt-2 text-center sm:text-left">Bitters chicharrones fanny pack
        ...
        <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@knyttneve</a>
                    ...
                    <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-600 text-sm">Enamel pin tousled raclette tacos irony</span>
                </div>
            </div>
        </footer>
    )
